...
struct Tips {
	static let tipList: [String] = [
		...
		"Remeber touching your phone while driving is illegal.\n" +
		"Ask a passenger to run tests for you instead.\n" +
		"Better yet, take a bus and run a number of tests as you move around",

		"The app will not conduct tests or ping your location when in " +
		...
		"Please do not exceed your data cap and run up a huge phone bill for " +
		...
		"The test will not start if you do not have a connection to the internet.\n" +
		...
		"Each test records your mobile carrier, cell tower id and signal strength.\n" +
		"If this sounds like too much information then please just conduct tests on wifi.",

		"Don't waste time and download limit on running twenty tests in the exact same " +
		...
		"Remember that uploading test results will use just as much data as " +
		"downloading them in the first place. You can always upload at a later date " +
		"on a wifi connection.",

		"Landgate are in no way affliated with this research project.\n" +
