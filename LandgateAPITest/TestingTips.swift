...
struct Tip {
	static let Number1: String = "Please don't test from home.\nThis is important for the sake of" +
	...
	static let Number2: String = "Remeber touching your phone while driving is illegal.\n" +
								"Ask a passenger to run tests for you instead.\n" +
								"Better yet, take a bus and run a number of tests as you move around"
	
	static let Number3: String = "The app will not conduct tests or ping your location when in " +
	...
	static let Number4: String = "Please do not exceed your data cap and run up a huge phone bill for " +
	...
	static let Number6: String = "Each test records your mobile carrier, cell tower id and signal strength.\n" +
								"If this sounds like to much information then please just conduct tests on wifi."
	
	static let Number7: String = "Don't waste time and download limit on running twenty tests in the exact same " +
