...
struct TestMaster {
	static let Templates: [TMTemplate] = [
		TMTemplate(
			...
			downloadSize: 2684, // This was 2100 for the GME version
			testPlan: [
		...
		TMTemplate(
			...
			downloadSize: , // This was 182 for the GME version
			testPlan: [
		...
		TMTemplate(
			...
			downloadSize: 1088, // This was 5843 for the GME version
			testPlan: [
				TestEndpoint.ESRI_Topo_Small_GET,
				TestEndpoint.ESRI_Topo_Small_POST,
				TestEndpoint.ESRI_Topo_Big_GET,
		...
		TMTemplate(
			...
			downloadSize: ,  // This was ???? for the GME version
			testPlan: [
				TestEndpoint.GME_GET_BusStops_Small,
